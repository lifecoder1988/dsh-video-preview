...
/**
 * The frame is exactly the pane's box, so the player can never give the body
 * something to scroll: it centres the video and clips nothing, because the
 * video is constrained to fit inside it while keeping its aspect ratio.
 */
...
/**
 * The player scales down to whichever pane edge binds first — a portrait clip
 * is bounded by the pane's height, a wide one by its width — and is never
 * enlarged past its intrinsic size.
 */
